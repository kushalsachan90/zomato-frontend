...
iconUrl: "https://unpkg.com/leaflet@1.9.4/dist/images/marker",
...
try {
const { data } = await
api.get(`${RestaurantService}/api/address/getAddress`, {
headers: {
...
setAdding(true);
await api.post(
`${RestaurantService}/api/address/AddAddress`,
{
formattedAddress,
mobileNo,
latitude,
...
try {
setDeletingId(id);
await api.delete(`${RestaurantService}/api/address/${id}`, {
headers: {
Authorization: `Bearer ${localStorage.getItem("token")}`,
},
});
...
medium">{addr.location.formattedAddress}</p>
